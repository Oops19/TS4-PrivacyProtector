...
class O19PrivacyProtector:
    game_loaded = False
    notify_user = False
    notify_message = f"Privacy violated.\r\nSee 'The Sims 4/mod_logs/{ModInfo.get_identity().name}.txt' for more details."
    ...
    def handle_event(event_data: S4CLZoneLateLoadEvent):
        O19PrivacyProtector.game_loaded = True
        if O19PrivacyProtector.notify_user:
            O19PrivacyProtector.notify_user = False
            O19PrivacyProtector.show_notification(O19PrivacyProtector.notify_message)

    @staticmethod
    @CommonEventRegistry.handle_events(ModInfo.get_identity().name)
    def handle_event(event_data: S4CLZoneTeardownEvent):
        O19PrivacyProtector.game_loaded = False
    ...
    def log_data(_method: str, *args, **kwargs):
        ...
        if O19PrivacyProtector.game_loaded:
            O19PrivacyProtector.show_notification(O19PrivacyProtector.notify_message)
        else:
            O19PrivacyProtector.notify_user = True

        raise PrivacyViolationException("Privacy violated")

"""
methods to inject into
"""
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), FTP, FTP.__init__.__name__, handle_exceptions=False)
    def o19_injected_ftplib_ftp(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('ftplib.FTP', *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), open, open.__init__.__name__, handle_exceptions=False)
    def o19_injected_webbrowser_open(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('webbrowser.open', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), startfile, startfile.__init__.__name__, handle_exceptions=False)
    def o19_injected_os_startfile(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('os.startfile', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), execl, execl.__init__.__name__, handle_exceptions=False)
    def o19_injected_os_execl(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('os.execl', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), execve, execve.__init__.__name__, handle_exceptions=False)
    def o19_injected_os_execve(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('os.execve', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), spawnv, spawnv.__init__.__name__, handle_exceptions=False)
    def o19_injected_os_spawnv(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('os.spawnv', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), spawnve, spawnve.__init__.__name__, handle_exceptions=False)
    def o19_injected_os_spawnve(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('os.spawnve', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), system, system.__init__.__name__, handle_exceptions=False)
    def o19_injected_os_system(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('os.system', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), popen, popen.__init__.__name__, handle_exceptions=False)
    def o19_injected_os_popen(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('os.popen', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), socketpair, socketpair.__init__.__name__, handle_exceptions=False)
    def o19_injected_socket_socketpair(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('socket.socketpair', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), fromfd, fromfd.__init__.__name__, handle_exceptions=False)
    def o19_injected_socket_fromfd(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('socket.fromfd', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), fromshare, fromshare.__init__.__name__, handle_exceptions=False)
    def o19_injected_socket_fromshare(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('socket.fromshare', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), create_connection, create_connection.__init__.__name__, handle_exceptions=False)
    def o19_injected_socket_create_connection(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('socket.create_connection', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), run, run.__init__.__name__, handle_exceptions=False)
    def o19_injected_subprocess_run(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('subprocess.run', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    def o19_injected_subprocess_popen(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('subprocess.Popen', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), call, call.__init__.__name__, handle_exceptions=False)
    def o19_injected_subprocess_call(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('subprocess.call', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), check_call, check_call.__init__.__name__, handle_exceptions=False)
    def o19_injected_subprocess_check_call(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('subprocess.check_call', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), check_output, check_output.__init__.__name__, handle_exceptions=False)
    def o19_injected_subprocess_check_output(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('subprocess.check_output', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), getoutput, getoutput.__init__.__name__, handle_exceptions=False)
    def o19_injected_subprocess_getoutput(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('subprocess.getoutput', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), getstatusoutput, getstatusoutput.__init__.__name__, handle_exceptions=False)
    def o19_injected_subprocess_getstatusoutput(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('subprocess.getstatusoutput', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), create_subprocess_shell, create_subprocess_shell.__init__.__name__, handle_exceptions=False)
    def o19_injected_asyncio_create_subprocess_shell(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('asyncio.create_subprocess_shell', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), get_event_loop_policy, get_event_loop_policy.__init__.__name__, handle_exceptions=False)
    def o19_injected_asyncio_get_event_loop_policy(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('asyncio.get_event_loop_policy', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), create_subprocess_exec, create_subprocess_exec.__init__.__name__, handle_exceptions=False)
    def o19_injected_asyncio_create_subprocess_exec(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('asyncio.create_subprocess_exec', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), urlopen, urlopen.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_urlopen(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.urlopen', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), Request, Request.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_request(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.Request', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), FancyURLopener, FancyURLopener.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_fancyurlopener(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.FancyURLopener', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), OpenerDirector, OpenerDirector.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_openerdirector(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.OpenerDirector', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), AbstractHTTPHandler, AbstractHTTPHandler.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_abstracthttphandler(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.AbstractHTTPHandler', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), BaseHandler, BaseHandler.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_basehandler(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.BaseHandler', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), ProxyHandler, ProxyHandler.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_proxyhandler(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.ProxyHandler', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), HTTPHandler, HTTPHandler.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_httphandler(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.HTTPHandler', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), FileHandler, FileHandler.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_filehandler(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.FileHandler', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), FTPHandler, FTPHandler.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_ftphandler(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.FTPHandler', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), CacheFTPHandler, CacheFTPHandler.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_cacheftphandler(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.CacheFTPHandler', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), URLopener, URLopener.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_urlopener(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.URLopener', *args, **kwargs)
        return original(self, *args, **kwargs)
...
try:
    ...
    @CommonInjectionUtils.inject_safely_into(ModInfo.get_identity(), ftpwrapper, ftpwrapper.__init__.__name__, handle_exceptions=False)
    def o19_injected_urllib_request_ftpwrapper(original, self, *args, **kwargs):
        O19PrivacyProtector.log_data('urllib.request.ftpwrapper', *args, **kwargs)
        return original(self, *args, **kwargs)
