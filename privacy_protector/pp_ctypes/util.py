...
if os.name == "nt":
    ...
    from privacy_protector.pp_ctypes.macholib.dyld import dyld_find as _dyld_find
    def find_library(name):
    ...
    from privacy_protector.pp_ctypes._aix import find_library
...
def test():
    from privacy_protector.pp_ctypes import cdll
    if os.name == "nt":
        print(cdll.msvcrt)
